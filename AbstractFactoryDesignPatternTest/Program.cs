...
Computer drg4060 = creator.CreateComputer(ComputerTypes.Dragon4060);
Computer ph3050 = creator.CreateComputer(ComputerTypes.Phoenix3050);
Console.WriteLine(drg4060.VideoCard.VideoCardName);
...
class ComputerCreator
{
    ...
    ICase _case;
    public Computer CreateComputer(ComputerTypes computerType)
    {
        IComputerFactory computerFactory = computerType switch
        {
            ComputerTypes.Dragon4060 => new DRAGON4060(),
            ComputerTypes.Phoenix3050 => new PHOENIX3050(),
        }; 
